...
const FeedbackCard = ({
  ...
  <motion.div
    ...
    className="bg-black-200 p-10 rounded-3xl xs:w-[450px] md:w-[550px] lg:w-[850px] xl:w-[1000px] w-full"
  >
...
const Testimonials = () => {
  return (
    <div className={`mt-12 bg-black-200 rounded-[20px]`}>
      ...
      <div
        className={`${styles.paddingX}  pb-14 flex flex-wrap gap-7 bg-tertiary rounded-b-2xl`}
      >
